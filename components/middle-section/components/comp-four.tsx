export default function CompFour() {
  return (
    <div className="flex flex-col gap-3  md:md-0 md:grid grid-cols-4 cols-span-1 md:h-[20%] gap-x-2">
      <div className="w-full  items-center text-foreground bg-card shadow-card/40  overflow-hidden h-full justify-center gap-1 flex flex-col  rounded-3xl shadow-md ">
